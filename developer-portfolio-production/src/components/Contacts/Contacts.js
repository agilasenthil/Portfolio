            ...
            <div className="contacts--container">
                ...
                <div className="contacts-body">
                    <div className="contacts-form">
                        <form onSubmit={handleContactForm}>
                            <div className="input-container">
                                ...
                                <input placeholder="Agila" value={name} onChange={(e) => setName(e.target.value)} type="text" name="Name" className={`form-input ${classes.input}`}/>
                            </div>
                            <div className="input-container">
                                <label htmlFor="Email"  className={classes.label}>Email</label>
                                <input placeholder="agilas@asu.edu" value={email} onChange={(e) => setEmail(e.target.value)} type="email" name="Email" className={`form-input ${classes.input}`}/>
                            </div>
                            <div className="input-container">
                    ...
                    <div className="contacts-details">
                        ...
                        <div className="personal-details">
                            <div className={classes.detailsIcon}>
                            <a href={socialsData.linkedIn} target="_blank" rel="noreferrer" style={{color: "#212121"}}>
                                    <FaLinkedinIn />
                                </a>
                            </div>
                            <a  className='small' href={socialsData.linkedIn} style={{color:theme.tertiary}}>{contactsData.name}</a>
                        </div>
